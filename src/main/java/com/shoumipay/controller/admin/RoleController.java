...
import com.shoumipay.domain.Role;
import com.shoumipay.domain.RolePermission;
import com.shoumipay.service.admin.PermissionService;
import com.shoumipay.service.admin.RolePermissionService;
import com.shoumipay.service.admin.RoleService;
...
public class RoleController {
    ...
    public void addRole(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (StringUtil.isNull(description)) {
            MessageUtil.failMessageFlag("角色名不能为空!", response);
            return;
        }
        if (StringUtil.isNull(roleStr)) {
            MessageUtil.failMessageFlag("角色简称不能为空!", response);
            return;
        }
        Role role = new Role();
        role.setDescription(description);
    ...
    //@RequiresPermissions("role:updateByPrimaryKey")//权限管理;
