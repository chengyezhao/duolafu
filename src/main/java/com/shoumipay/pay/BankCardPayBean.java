...
public class BankCardPayBean extends TranBaseBean{
    ...
    private String            confirm_code;         //确认付款验证码，来自付款申请接口返回
    ...
    private String version;//版本号 1.1
    private String app_request;//请求应用标识
   ...
   /* "{\"frms_ware_category\":\"2009\",\"user_in\n" +
    "fo_mercht_userno\":\"123456\",\"user_inf\n" +
            "o_bind_phone\":\"13812345678\",\"user_i\n" +
            "nfo_dt_register\":\"20141015165530\",\"u\n" +
            "ser_info_full_name\":\" 张 三\n" +
            "\",\"user_info_id_no\":\"330682199001212\n" +
            "1221\",\"user_info_identify_type\":\"1\",\"us\n" +
            "er_info_identify_state\":\"1\"}"*/
    ...
    private String			  schedule_repayment_date;  // 还款计划编号
