...
import com.shoumipay.dao.PermissionMapper;
import com.shoumipay.domain.Permission;
import com.shoumipay.domain.PermissionExample;
import com.shoumipay.domain.PermissionExample.Criteria;
...
public class PermissionServiceImpl implements PermissionService {
     ...
     * 处理查询条件
     */
    private void proSearchParam(Permission permission, Criteria criteria) {
        if (permission != null) {
