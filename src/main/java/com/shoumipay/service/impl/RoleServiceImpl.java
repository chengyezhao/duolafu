...
import com.shoumipay.dao.RoleMapper;
import com.shoumipay.domain.Role;
import com.shoumipay.domain.RoleExample;
import com.shoumipay.domain.RoleExample.Criteria;
...
public class RoleServiceImpl implements RoleService {
     ...
     * 处理查询条件
     */
    private void proSearchParam(Role role, Criteria criteria) {
        if (role != null) {
            if (role.getId() != null) {
