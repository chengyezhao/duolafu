...
public class UserUtil {
     ...
     * 用户登录密码
     */
    public static String getMD5Password(String password, Member member) {
        return Md5Util.getMD5(Md5Util.getMD5(member.getUsername() + password + member.getCredentialsSalt()));
    }
