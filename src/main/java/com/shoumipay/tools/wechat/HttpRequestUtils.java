...
public class HttpRequestUtils {
    ...
    public static String sendPostXml(String url, String xml) {
        logger.info("sendPostXml " + url + xml);
        try {
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, String param, Boolean isJsonBody) {
        logger.info("sendPost " + url + isJsonBody);
