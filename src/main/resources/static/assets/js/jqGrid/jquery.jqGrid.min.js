...
(function (b) {
    b.jgrid = b.jgrid || {};
    b.extend(b.jgrid, {
        version: "4.5.2", htmlDecode: function (b) {
            ...
            k = h.getSeconds();
            var l = h.getMilliseconds(), o = h.getDay(), n = h.getFullYear(), m = (o + 6) % 7 + 1,
                t = (new Date(n, j - 1, g) - new Date(n, 0, 1)) / 864E5, A = {
                    d: a(g),
                    D: e.dayNames[o],
                    j: g,
                    l: e.dayNames[o + 7],
                    ...
                    w: o,
                    z: t,
                    W: 5 > m ? Math.floor((t + m - 1) / 7) + 1 : Math.floor((t + m - 1) / 7) || (4 > ((new Date(n - 1, 0, 1)).getDay() + 6) % 7 ? 53 : 52),
                    ...
                    e: "?",
                    I: "?",
                    O: (0 < i ? "-" : "+") + a(100 * Math.floor(Math.abs(i) / 60) + Math.abs(i) % 60, 4),
                    P: "?",
            ...
            var d = b("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;'></td></tr></table></div>"),
                f = d.appendTo("body").find("td").width();
            d.remove();
            return 5 !== f
            ...
            return new function (d, c) {
                ...
                var e =
                        this, a = d, j = !0, g = !1, h = c, i = /[\$,%]/g, k = null, l = null, o = 0, n = !1, m = "",
                    t = [], A = !0;
            ...
            if (!this.grid) {
                var e = b.extend(!0, {
                    ...
                    headers: [], cols: [], footers: [], dragStart: function (c, d, g) {
                        ...
                        if (this.resizing) {
                            var b = a.clientX - this.resizing.startX, a = this.headers[this.resizing.idx],
                                c = "ltr" === e.direction ? a.width + b : a.width - b, d;
                        ...
                        var c = a.p, d = c.selrow, e = c.selarrrow ? b.makeArray(c.selarrrow) : null,
                            g = a.grid.bDiv.scrollLeft, f = function () {
                                var h;
                                c.selrow = null;
                                c.selarrrow = [];
                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode) alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model); else {
                        ...
                        var o = function (a, b) {
                            ...
                            var j = "-1", i = "", k, d = d ? "display:none;" : "",
                                e = "ui-widget-content jqgrow ui-row-" + a.p.direction +
                                    (e ? " " + e : "") + (h ? " ui-state-highlight" : ""),
                            ...
                            var h = new Date,
                                ...
                                i = a.p.xmlReader, k = a.p.datatype === "local" ? "local" : "xml";
                            if (j) {
                                a.p.data = [];
                                a.p._index = {};
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                var F = b(a), y, G, l = 0, o, s = a.p.multiselect === true ? 1 : 0, u = 0, n,
                                    m = a.p.rownumbers ===
                                    true ? 1 : 0, t, p = [], E, q = {}, x, D, r = [],
                                    K = a.p.altRows === true ? a.p.altclass : "", v;
                                if (a.p.subGrid === true) {
                                    u = 1;
                            ...
                            if (c) {
                                ...
                                var k = b(a), l = 0, y, o, n, m = [], s = a.p.multiselect ? 1 : 0,
                                    u = a.p.subGrid === true ? 1 : 0, t, p = a.p.rownumbers === true ? 1 : 0,
                                    w = U(s + u + p);
                                i = $(i);
                            ...
                            if (b.isArray(a.p.data)) {
                                ...
                                if (a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype,
                                    ...
                                    var u = s.select(), v = parseInt(a.p.rowNum, 10), w = u.length,
                                        A = parseInt(a.p.page, 10), B = Math.ceil(w / v), q = {},
                                        u = u.slice((A - 1) * v, A * v), f =
                                            s = null;
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (a.p.rowTotal !== null && f.totalrows !== null) e[f.totalrows] =
                                    a.p.rowTotal;
                                var h = b.isFunction(a.p.loadComplete), i = h ? a.p.loadComplete : null, j = 0,
                                    c = c || 1;
                                        ...
                                        case "script":
                                            b.ajax(b.extend({
                                                ...
                                                data: b.isFunction(a.p.serializeGridData) ?
                                                    a.p.serializeGridData.call(a, a.p.postData) : a.p.postData,
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                b("#first" + b.jgrid.jqID(d) + ", #prev" + b.jgrid.jqID(d) + ", #next" + b.jgrid.jqID(d) + ", #last" + b.jgrid.jqID(d)).click(function () {
                                    var b = o(a.p.page, 1), c = o(a.p.lastpage, 1), e = false, g = true, f = true,
                                        h = true, i = true;
                        ...
                        var Z = null,
                            i = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id +
                                "' cellspacing='0' cellpadding='0' border='0'></table>").append(B),
                            H = a.p.caption && !0 === a.p.hiddengrid ? !0 : !1;
    ...
    b.jgrid.extend({
        getGridParam: function (b) {
            ...
            return this.each(function () {
                ...
                if (void 0 !== d && (f = !1 ===
                    ...
                    if (this.setHeadCheckBox(!1), this.p.selrow =
                        ...
                        "aria-selected": "true",
                        tabindex: "0"
                    }), i && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).addClass("ui-state-highlight")), e = !0) : e = !1, this.p.selrow = a.id, f)) b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, e, c)
            })
            ...
            this.each(function () {
                ...
                if (f) try {
                    if (b(this.p.colModel).each(function (a) {
                        ...
                        if (g.p.treeGrid) for (m in g.p.treeReader) g.p.treeReader.hasOwnProperty(m) &&
            ...
            return this.each(function () {
                if (this.grid) {
                    var c = this, e, a = 0, j = b.jgrid.cell_width ? 0 : c.p.cellLayout, g, h = 0, i = !1,
                        k = c.p.scrollOffset, l, o = 0, n;
                    ...
                    if (l && 0 < l) {
                        for (; o < l;) {
                            if (b(this.rows[o]).hasClass("jqgrow")) {
                                try {
                                    a = b.unformat.call(this, b(this.rows[o].cells[k]), {
                                ...
                                c ? (i = parseFloat(a), j += i, void 0 === h && (h = g = i), g = Math.min(g, i), h = Math.max(h, i)) : f ? e.push({
                                    id: this.rows[o].id,
                                    value: a
                                }) : e.push(a)
                            }
...
(function (a) {
    ...
    a.unformat = function (c, b, d, e) {
        var f, g = b.colModel.formatter, h = b.colModel.formatoptions || {}, j = /([\.\*\_\'\(\)\{\}\+\?\\])/g,
    ...
    a.jgrid.extend({
        ...
        setGridState: function (b) {
            ...
            return this.each(function () {
                ...
                if (!this.ftoolbar) {
                    var f = function () {
                        ...
                        a("#sopt_menu").remove();
                        var d = parseInt(d, 10), j = parseInt(j, 10) + 18,
                            d = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:' + (a(".ui-jqgrid-view").css("font-size") || "11px") + ";left:" + d + "px;top:" + j + 'px;">',
                            j = a(e).attr("soper"),
                    ...
                    a.each(c.p.colModel, function () {
                        ...
                        var l = "=", s,
                            ...
                            i = a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"),
                        ...
                        if (this.search) {
                            ...
                            switch (this.stype) {
                                case "select":
                                    if (g = this.surl || d.dataUrl) a.ajax(a.extend({
                    ...
                    this.clearToolbar =
                        function (e) {
                            ...
                            a.each(c.p.colModel, function () {
                                var b,
                                    e = a("#gs_" + a.jgrid.jqID(this.name), this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv : c.grid.hDiv);
            ...
            return this.each(function () {
                ...
                var c, f, g = 0, j, h, e, d, p, l = this.p.colModel, s = l.length, n = this.grid.headers,
                    i = a("table.ui-jqgrid-htable", this.grid.hDiv),
                    k = i.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
                j = i.children("thead");
                var m = i.find(".jqg-first-row-header");
                void 0 === m[0] ? m = a("<tr>", {
                    role: "row",
                    "aria-hidden": "true"
                }).addClass("jqg-first-row-header").css("height", "auto") : m.empty();
                ...
                for (c = 0; c < s; c++) if (e = n[c].el, d = a(e), f = l[c], h = {
                        height: "0px",
                        width: n[c].width + "px",
                    ...
                    h = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                        height: "22px",
                        "border-top": "0px none"
                    }).html(p);
                    ...
                    j.append(e);
                    g -= 1
                } else 0 === g ? b.useColSpanStyle ? d.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                    display: f.hidden ? "none" : "",
                    "border-top": "0px none"
                }).insertBefore(d), j.append(e)) : (j.append(e), g--);
...
(function (a) {
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            var c = a.extend(!0, {}, a.jgrid.jqModal || {}, c), i = document.createElement("div"), j, n = this,
                f = a.extend({}, f || {});
            ...
            switch (d) {
                ...
                case "select":
                    ...
                    !0 === b.multiple ? (d = !0, f.multiple = "multiple", a(f).attr("aria-multiselectable", "true")) :
                        d = !1;
                    if (void 0 !== b.dataUrl) d = b.name ? ("" + b.id).substring(0, ("" + b.id).length - ("" + b.name).length - 1) : "" + b.id, g = b.postData || e.postData, i.p && i.p.idPrefix ? d = a.jgrid.stripPref(i.p.idPrefix, d) : g = void 0, a.ajax(a.extend({
                        url: b.dataUrl,
                        type: "GET",
                        dataType: "html",
                        data: a.isFunction(g) ? g.call(i, d, c, "" + b.name) : g,
                        context: {elem: f, options: b, vl: c},
                        success: function (d) {
                            var b = [], c = this.elem, e = this.vl, f = a.extend({}, this.options),
                                g = f.multiple === true, d = a.isFunction(f.buildSelect) ? f.buildSelect.call(i, d) : d;
                            typeof d === "string" &&
                            (d = a(a.trim(d)).html());
                            if (d) {
                                a(c).append(d);
                ...
                case "custom":
                    ...
                    try {
                        if (a.isFunction(b.custom_element)) if (l = b.custom_element.call(i, c, b)) l = a(l).addClass("customelement").attr({
                            id: b.id,
                            name: b.name
                        }), a(f).empty().append(l); else throw"e2"; else throw"e1";
                    } catch (m) {
    ...
    a.jgrid.extend({
        searchGrid: function (b) {
                ...
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id))); else {
                        ...
                        var n = a.extend([], e.p.colModel),
                            x = "<a href='javascript:void(0)' id='" + i + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" +
                                b.Find + "</a>",
                            d = "<a href='javascript:void(0)' id='" + i + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>",
                            q = "", f = "", o, k = !1, p = -1;
                        ...
                        a("#" + i + "_search").bind("click", function () {
                            ...
                            b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(u.themodal), {
                                gb: "#gbox_" +
            ...
            return this.each(function () {
                    ...
                    a(e.p.colModel).each(function (r) {
                        ...
                        if ("cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                            if (!1 === q) i = ""; else if (h === e.p.ExpandColumn && !0 === e.p.treeGrid) i = a("td[role='gridcell']:eq(" + r + ")", e.rows[q]).text(); else {
                                try {
                                    i = a.unformat.call(e,
                                        a("td[role='gridcell']:eq(" + r + ")", e.rows[q]), {
                                            rowId: c,
                                            colModel: this
                                        }, r)
                                } catch (t) {
                            ...
                            var v = a.extend({}, this.editoptions || {}, {id: h, name: h}), s = a.extend({}, {
                                    elmprefix: "",
                                    elmsuffix: "",
                                    rowabove: !1,
                                    rowcontent: ""
                                }, this.formoptions || {}), w = parseInt(s.rowpos, 10) || p + 1,
                                u = parseInt(2 * (parseInt(s.colpos,
                                    10) || 1), 10);
                        ...
                        o && (a('td[role="gridcell"]', o).each(function (j) {
                            ...
                            if ("cb" !== l && "subgrid" !== l && "rn" !== l && !0 === m[j].editable) {
                                ...
                                switch (m[j].edittype) {
                                    ...
                                    case "checkbox":
                                        g = "" + g;
                                        if (m[j].editoptions && m[j].editoptions.value) if (m[j].editoptions.value.split(":")[0] === g) a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]({
                                            checked: !0,
                                            defaultChecked: !0
                                        }); else a("#" +
                                            l, "#" + f)[d.p.useProp ? "prop" : "attr"]({
                                            checked: !1,
                                            defaultChecked: !1
                                        }); else g = g.toLowerCase(), 0 > g.search(/(false|f|0|no|n|off|undefined)/i) && "" !== g ? (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                                        break;
                                    case "custom":
                                        try {
                ...
                function s() {
                    ...
                    if (l[0] && !b[d.p.id].processing) {
                            ...
                            complete: function (g,
                                ...
                                if (l[0] === false) {
                                    ...
                                    if (j[m] === h.addoper) {
                                        ...
                                        b[d.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(q),
                                            jqm: c.jqModal,
                                            onClose: b[d.p.id].onClose
                                        })
                        ...
                        l[0] && (b[d.p.id].useDataProxy ? (g = d.p.dataProxy.call(d, n, "set_" + d.p.id), void 0 === g && (g = [!0, ""]), !1 === g[0] ? (l[0] = !1, l[1] = g[1] || "Error deleting the selected row!") : (n.data.oper === h.addoper && b[d.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {
                            gb: "#gbox_" + a.jgrid.jqID(q),
                            jqm: c.jqModal,
                            onClose: b[d.p.id].onClose
                        }), n.data.oper === h.editoper && b[d.p.id].closeAfterEdit &&
                        a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {
                            gb: "#gbox_" + a.jgrid.jqID(q),
                            jqm: c.jqModal,
                            onClose: b[d.p.id].onClose
                ...
                var d = this;
                if (d.grid && r) {
                    var q = d.p.id, f = "FrmGrid_" + q, o = "TblGrid_" + q, k = "#" + a.jgrid.jqID(o), p = {
                            themodal: "editmod" + q,
                            modalhead: "edithd" + q,
                            modalcontent: "editcnt" + q,
                            scrollelm: f
                        }, y = a.isFunction(b[d.p.id].beforeShowForm) ? b[d.p.id].beforeShowForm :
                        !1, A = a.isFunction(b[d.p.id].afterShowForm) ? b[d.p.id].afterShowForm : !1,
                        w = a.isFunction(b[d.p.id].beforeInitData) ? b[d.p.id].beforeInitData : !1,
                        B = a.isFunction(b[d.p.id].onInitializeForm) ? b[d.p.id].onInitializeForm : !1, l = !0, z = 1,
                        F = 0, j, K, v, f = a.jgrid.jqID(f);
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                        ...
                        var E = isNaN(c.dataheight) ? c.dataheight :
                            c.dataheight + "px", l = isNaN(c.datawidth) ? c.datawidth : c.datawidth + "px",
                            ...
                            C = a("<table id='" + o + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                            l = a(d).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + f), v]);
                        void 0 === l && (l = !0);
                        l && w && (l = w.call(d, a("#" + f, v)));
                        if (!1 === l) return;
                        g();
                        ...
                        var l = "<a href='javascript:void(0)' id='" + l + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                            D = "<a href='javascript:void(0)' id='" + D + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",
                            H = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>" + c.bSubmit + "</a>",
                            I = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + c.bCancel + "</a>",
                            o = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + o + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" +
                                (w ? D + l : l + D) + "</td><td class='EditButton'>" + H + I + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + b[d.p.id].bottominfo + "</td></tr>"),
                            o = o + "</tbody></table>";
                        if (0 < F) {
                            var J = [];
                        ...
                        a("#" + a.jgrid.jqID(p.themodal)).keydown(function (e) {
                            ...
                            if (e.which === 27) {
                                if (!h()) return false;
                                L && a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {
                                    gb: c.gbox,
                                    jqm: c.jqModal,
                                    onClose: b[d.p.id].onClose
                                });
            ...
            return this.each(function () {
                ...
                function i(b, d, e, g) {
                    var f, h, i, k = 0, p, m, n = [], r = !1, o,
                        q = "<td class='CaptionTD form-view-label ui-widget-content' width='" + c.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
                ...
                var m = this;
                if (m.grid && r) {
                    var h = m.p.id, g = "ViewGrid_" + a.jgrid.jqID(h), n = "ViewTbl_" + a.jgrid.jqID(h),
                        x = "ViewGrid_" +
                            h, d = "ViewTbl_" + h, q = {
                            themodal: "viewmod" + h,
                            modalhead: "viewhd" + h,
                            ...
                            scrollelm: g
                        }, f = a.isFunction(b[m.p.id].beforeInitData) ? b[m.p.id].beforeInitData : !1, o = !0, k = 1, p = 0;
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                        ...
                        var y = isNaN(c.dataheight) ? c.dataheight : c.dataheight + "px",
                            ...
                            w = a("<table id='" + d + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                        f && (o = f.call(m, a("#" + g)), void 0 === o && (o = !0));
                        if (!1 === o) return;
                        ...
                        a("#" + q.themodal).keydown(function (d) {
                            if (d.which === 27) {
                                b[m.p.id].closeOnEscape && a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {
                                    gb: c.gbox,
                                    jqm: c.jqModal,
                                    onClose: c.onClose
                                });
            ...
            return this.each(function () {
                var e = this;
                if (e.grid && r) {
                    var i = a.isFunction(b[e.p.id].beforeShowForm), t = a.isFunction(b[e.p.id].afterShowForm),
                        u = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, s = e.p.id, m = {},
                        h = !0, g = "DelTbl_" + a.jgrid.jqID(s), n, x, d, q, f = "DelTbl_" + s, o = {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(o.themodal))[0]) {
                        ...
                        var k = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px",
                            p = isNaN(c.datawidth) ? c.datawidth : c.datawidth + "px",
                            f = "<div id='" + f + "' class='formdata' style='width:" + p + ";overflow:auto;position:relative;height:" + k + ";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>" + ("<tr id='DelData' style='display:none'><td >" + r + "</td></tr>"),
                            f = f + ('<tr><td class="delmsg" style="white-space:pre;">' + b[e.p.id].msg +
                                "</td></tr><tr><td >&#160;</td></tr>"),
                            f = f + "</tbody></table></div>" + ("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + g + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + ("<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + c.bSubmit + "</a>") + "&#160;" + ("<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + c.bCancel + "</a>") + "</td></tr></tbody></table>");
                        ...
                        a("#dData", "#" + g + "_2").click(function () {
                            ...
                            if (f[0] && !b[e.p.id].processing) {
                                ...
                                h = a.extend({
                                    ...
                                    type: b[e.p.id].mtype,
                                    data: a.isFunction(b[e.p.id].serializeDelData) ? b[e.p.id].serializeDelData.call(e,
                                        n) : n,
                                ...
                                if (!h.url &&
                                    !b[e.p.id].useDataProxy) if (a.isFunction(e.p.dataProxy)) b[e.p.id].useDataProxy = true; else {
                                    f[0] = false;
                ...
                if (!this.nav) {
                    ...
                    if (h.grid && "string" === typeof b) {
                        void 0 === a("#" + m.themodal)[0] && (!c.alerttop && !c.alertleft && (void 0 !== window.innerWidth ? (c.alertleft = window.innerWidth, c.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (c.alertleft = document.documentElement.clientWidth,
                            c.alerttop = document.documentElement.clientHeight) : (c.alertleft = 1024, c.alerttop = 768), c.alertleft = c.alertleft / 2 - parseInt(c.alertwidth, 10) / 2, c.alerttop = c.alerttop / 2 - 25), a.jgrid.createModal(m, "<div>" + c.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                            gbox: "#gbox_" + a.jgrid.jqID(h.p.id),
                            jqModal: !0,
                            drag: !0,
                            resize: !0,
                            caption: c.alertcap,
                        ...
                        for (x = 0; x < n; x++) {
                            ...
                            c.edit &&
                            (g = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", f).append(g), a(g, f).attr({
                                title: c.edittitle || "",
                                id: e.id || "edit_" + k
                            }).click(function () {
            ...
            if (!this.filter) {
                ...
                if (l) {
                    ...
                    this.createTableForGroup = function (g, j) {
                        var b = this, c,
                            k = a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"),
                            e = "left";
    ...
    a.jgrid.extend({
        editRow: function (c, b, e, o, l, g, n, h, f) {
            ...
            var f = a.extend(!0, {
                ...
                restoreAfterError: !0,
                mtype: "POST"
            }, a.jgrid.inlineEdit, f), j = !1, d = this[0], m, i = {}, w = {}, r = {}, t, s, q;
            if (!d.grid) return j;
                    ...
                    b.edit && a(e).jqGrid("navButtonAdd",
                        c, {
                            ...
                            onClickButton: function () {
                                ...
                                c ? (a(e).jqGrid("editRow", c, b.editParams), a("#" + l + "_ilsave").removeClass("ui-state-disabled"), a("#" + l + "_ilcancel").removeClass("ui-state-disabled"), a("#" + l + "_iladd").addClass("ui-state-disabled"), a("#" + l + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {
                                    gbox: "#gbox_" + l,
                                    jqm: !0
                                }), a("#jqg_alrt").focus())
                            }
                ...
                function d(c, d, e) {
                    if ("v" === e.substr(0, 1)) {
                        var f =
                            ...
                            l = a.rows[c].offsetTop + a.rows[c].clientHeight, o = a.rows[c].offsetTop;
...
(function (c) {
    ...
    c.jqm = {
        hash: {}, open: function (a, i) {
            var b = j[a], e = b.c, h = "." + e.closeClass, f = parseInt(b.w.css("z-index")), f = 0 < f ? f : 3E3,
                g = c("<div></div>").css({
                    height: "100%",
                    width: "100%",
                    position: "fixed",
    ...
    d.jgrid.extend({
        groupingSetup: function () {
            return this.each(function () {
                ...
                if (null !== a && ("object" === typeof a ||
                    ...
                    a.summary = [];
                    b = 0;
                    for (g = f.length; b < g; b++) f[b].summaryType && a.summary.push({
                        nm: f[b].name,
                        st: f[b].summaryType,
                        v: "",
                        sr: f[b].summaryRound,
            ...
            this.each(function () {
                ...
                for (c = 0; c < k; c++) l = e.groupField[c], m = e.displayField[c],
                    j = f[l], m = null == m ? null : f[m], null == m && (m = j), void 0 !== j && (0 === a ? (e.groups.push({
                    idx: c,
                    dataIndex: l,
                    value: j,
                    displayValue: m,
                ...
                }) : "object" !== typeof j && (d.isArray(e.isInTheSameGroup) && d.isFunction(e.isInTheSameGroup[c]) ? !e.isInTheSameGroup[c].call(h, e.lastvalues[c], j, c, e) : e.lastvalues[c] !== j) ? (e.groups.push({
                    idx: c,
                    dataIndex: l,
                    value: j,
                    displayValue: m,
            ...
            this.each(function () {
                ...
                var f = f.join("_"), e = g.minusicon, h = g.plusicon, c = d("#" + d.jgrid.jqID(b)),
                    c = c.length ? c[0].nextSibling : null,
                    k = d("#" + d.jgrid.jqID(b) + " span.tree-wrap-" + this.p.direction), l = !1;
                if (k.hasClass(e)) {
        ...
        groupingData: function (b) {
            ...
            return this.each(function () {
                ...
                var a = this, e = a.p.groupingView, h = "", c = "", k, l,
                    j = e.groupCollapse ? e.plusicon : e.minusicon, m, q = [], w = e.groupField.length,
    ...
    d.jgrid.extend({
        setTreeNode: function (b, c) {
                ...
                if (a.grid && a.p.treeGrid) switch (a.p.treeGridModel) {
                    case "nested":
                        var h = a.p.treeReader.left_field, e = a.p.treeReader.right_field,
                            i = a.p.treeReader.level_field, g = parseInt(b[h], 10), f = parseInt(b[e], 10),
                            l = parseInt(b[i], 10);
            ...
            this.each(function () {
                ...
                if (a.grid && a.p.treeGrid) switch (a.p.treeGridModel) {
                    case "nested":
                        var e = a.p.treeReader.left_field, i = a.p.treeReader.right_field,
                            g = a.p.treeReader.level_field, f = parseInt(b[e], 10), l = parseInt(b[i], 10),
                            k = parseInt(b[g], 10);
                        d(this.p.data).each(function () {
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var c =
                            this.p.treeReader.expanded_field, a = this.p.treeReader.parent_id_field,
                        h = this.p.treeReader.loaded, e = this.p.treeReader.level_field,
                        i = this.p.treeReader.left_field, g = this.p.treeReader.right_field;
                    if (!b[c]) {
                        var f = d.jgrid.getAccessor(b, this.p.localReader.id),
                            l = d("#" + this.p.idPrefix + d.jgrid.jqID(f), this.grid.bDiv)[0], k = this.p._index[f];
                        d(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) :
                            this.grid.hDiv.loading || (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel ? d(this).jqGrid("setGridParam", {
                                postData: {
                                    nodeid: f,
                                    n_left: b[i],
                                    n_right: b[g],
        ...
        SortTree: function (b, c, a, h) {
            ...
            var e = this[0];
            if (a) {
                var i = e.p.treeReader.expanded_field, g = e.p.treeReader.leaf_field, f = e.p.treeReader.level_field,
                    l = e.p.treeReader.parent_id_field, k = e.p.treeReader.left_field, m = e.p.treeReader.right_field,
                    n = e.p.treeReader.loaded, j, r, q, t, p;
                j = 0;
                var s = c, u;
                void 0 === h && (h = !1);
                if (void 0 === b || null === b) {
