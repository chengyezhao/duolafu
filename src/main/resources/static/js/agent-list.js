...
$(function () {
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            { label: '上级', name: 'agentName', width:100 },
            { label: '累计佣金金额', name: 'balance', width:100 },
        ],
    ...
    $("#queryBtn").click(function () {
       ...
       /* $.ajax({
            url:"agent/queryList",
            type:"post",
            data:{"startTime":startTime,"endTime":endTime,"id":id,"agentType":agentType},
            success: function (result) {
                $.messager.alert(result.message);
            }
        });*/
        $(grid_selector).jqGrid('setGridParam', {
            postData: {startTime: startTime, endTime: endTime,id:id,agentType:agentType},
            //search: true,
            page: 1
        }).trigger("reloadGrid");
    });
