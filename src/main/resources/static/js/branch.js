...
$(function () {
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            {label: '添加时间', name: 'createTime', width: 100},
            {label: '放款额', name: 'amount', width: 100},
            {label: '代理佣金比例', name: 'commisionRate', width: 100},
        ],
...
//查询点击事件
    $("#query").click(function () {
        ...
        $(grid_selector).jqGrid('setGridParam', {
            postData: {start: start, end: end,memberId:memberId,agentIds:agentIds},
            //search: true,
            page: 1
        }).trigger("reloadGrid");
    });
