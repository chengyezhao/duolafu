...
$(function () {
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            {label: '芝麻调用量', name: 'alizhimaCall', width: 60},
            {label: '有盾实名认证', name: 'blacklist', width: 60},
            {label: '运营商三要素', name: 'jiaoCall', width: 60},
            {label: '短信调用量', name: 'smsCall', width: 60},
            {label: '银行卡四要素', name: 'bankCall', width: 60},
        ],
