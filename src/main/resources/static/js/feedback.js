...
$(function () {
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            {label: '操作', width: 150, formatter: function (cellvalue, options, cell) {
                return '<button  onclick="reply('
                    + cell.uid + ');" style="margin-left: 10px" class="btn btn-info btn-sm btn-label-left radius" ><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i>回复</button>';
            }
            }
        ],
    ...
    $("#query").click(function () {
        ...
        $(grid_selector).jqGrid('setGridParam', {
            postData: {phoneNumber:phoneNumber,key:key,start: start, end: end},
            //search: true,
            page: 1
        }).trigger("reloadGrid");
    });
