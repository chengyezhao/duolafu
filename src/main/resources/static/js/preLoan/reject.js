    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            {label: '申请人', name: 'phoneNumber', width: 100, formatter: function (cellvalue, options, cell) {
                return '<a onclick="alert( ' + cell.memberId + ');" style="cursor: pointer">' + cell.phoneNumber + '</a>';
            }},
            ...
            //     return '<button disabled="disabled"  onclick="loan(' + cell.id + ');" class="btn btn-info btn-sm btn-label-left radius" ><i class="glyphicon glyphicon-yen" aria-hidden="true"></i>放款</button>';
            // }}
        ],
